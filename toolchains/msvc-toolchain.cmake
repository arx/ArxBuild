...
foreach(_msvc_dir IN LISTS _msvc_dirs)
	string(REGEX REPLACE "\\-[0-9]+$" "" _msvc_ver_noarch "${_msvc_ver}")
	string(REGEX REPLACE "\\.[0-9]+$" "" _msvc_ver_major "${_msvc_ver_noarch}")
	foreach(_ver IN ITEMS ${_msvc_ver} ${_msvc_ver_noarch} ${_msvc_ver_major})
		if(EXISTS ${_msvc_wineroot}/${_msvc_dir}/${_ver})
			list(APPEND CMAKE_SYSTEM_PREFIX_PATH /${_msvc_dir}/${_ver})
		endif()
	endforeach()
	unset(_msvc_ver_major)
	unset(_msvc_ver_noarch)
